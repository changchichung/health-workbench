...
export const BATCH_DOCS = [
  ...
  { id: 1, filename: "STR.edf", adapter: "resmed_edf",
    ...
    import_stats: stats({ cpap_daily: 259, cpap_events: 286 }, { cpap_daily_unused: 214 }) },
  { id: 2, filename: "DATALOG/20230612_EVE.edf", adapter: "resmed_edf",
    imported_at: "2026-08-13 02:50:12", import_stats: stats({ cpap_events: 27 }) },
...
export const EXPECTED_BATCHES = [
  { key: "resmed_edf|2026-08-13 02:50:12",
    ...
    inserted: { cpap_daily: 259, cpap_events: 327 }, dupTotal: 214, missingStats: false },
